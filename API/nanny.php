...
if($registros->num_rows > 0){
    while($nanny = $registros->fetch_assoc()){$nuevaNanny = array ('idNanny' => intval($nanny['idNanny']), 'usuario' => $nanny['usuario'], 'password' => $nanny['password'], 'nombre' => $nanny['nombre'], 'apellido' =>    $nanny['apellido'], 'domicilio' => $nanny['domicilio'], 'ciudad' => $nanny['ciudad'], 
